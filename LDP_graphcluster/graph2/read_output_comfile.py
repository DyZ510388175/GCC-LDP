...
# comparison_musae_PTBR_edges_sample_mean

filename = 'comparison_musae_PTBR_edges_sample_mean'
# 读取文本文件内容
...
df = pd.DataFrame(data_list,
                  columns=['Algorithm', 'privacy_budget', 'Modularity', 'Normalized Mutual Information', 'F1 Score',
...
# 将结果保存到CSV文件
result_df.to_csv(r'../output/out/' + 'comparison_' + filename + '.csv')
