...
from graph2.compressed_set import get_all_subitems
from graph2.compressed_set2 import CompressedSet, GCC_Compressed_LDP_Run_and_output_res, cluster_list_To_mapping, \
    compressed_set_to_clusters, draw_spring
...
def GCC_Run(graph, threshold_d, threshold_beta, threshold_s):
    ...
    gcc_cluster = GCC_cluster(compressed_set, adjacency_vectors, item_frequencies)
