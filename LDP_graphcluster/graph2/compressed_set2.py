...
class CompressedSet:
    ...
    def get_adjacency_vectors_custom(self, compressed_set):
    ...
    # 计算每一项的频率
    def calculate_item_frequencies_custom(self, adjacency_vectors_custom, compressed_set):
    ...
    def calculate_pair_connectionStrength_custom(self, compressed_set, adjacency_vectors_custom, item_frequencies,
        ...
        for pair in pair_items:
            ...
            for v_dix, adjacency_vector in enumerate(adjacency_vectors_custom):
                ...
                if str(v_dix) not in dict_j and str(v_dix) not in dict_k and adjacency_vector[idx_dict_j] != 0 and adjacency_vector[idx_dict_k] != 0:
...
def draw_spring(G, com):
    ...
    color_list = ['pink', 'orange', 'r', 'slateblue', 'dodgerblue', 'khaki', 'tomato','g', 'b', 'y', 'm', 'gray', 'black', 'c', 'brown',
...
def GCC_Compressed_LDP_Run_and_output_res(graph, threshold_d, threshold_beta):
