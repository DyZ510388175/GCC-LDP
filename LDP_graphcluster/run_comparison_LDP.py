...
from graph.wdt_scan import WdtSCAN
from graph.gc_nldp import GCNLDP
...
if __name__ == '__main__':
    ...
    #             'CA-CondMat_sample', 'musae_ES_edges_sample', 'musae_git_edges_sample', 'CA-HepTh_sample', 'musae_PTBR_edges_sample', 'com-dblp.all.cmty']
    ...
    privacy_budgets = [0.05, 1, 3, 5, 7, 9, 11, 13]  # 设置隐私预算
    ...
    for file_idx, file in enumerate(filename):
        ...
        for privacy_budget in privacy_budgets:
            ...
            WdtSCAN_metrics_lists = []
            WdtSCAN_metrics_list_mean = []
            WdtSCAN_metrics_list_max = []
            WdtSCAN_RunTime_sum = 0

            GCNLDP_metrics_lists = []
            GCNLDP_metrics_list_mean = []
            GCNLDP_metrics_list_max = []
            GCNLDP_RunTime_sum = 0
            ...
            for loop in range(loop_max):
                ...
                WdtSCAN_result = wdt_model.cluster(G, num_clusters=num_clusters)
