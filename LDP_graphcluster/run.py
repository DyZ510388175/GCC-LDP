...
from graph2.compressed_set2 import draw_spring, cluster_list_To_mapping
...
if __name__ == '__main__':
    ...
    read_G = nx.read_edgelist('dataset/karate2.txt')
    G = processing_indexOfnodes(read_G)

    # # 遍历 G2 中的所有节点，并将它们添加到 G 中
    # for node in G2.nodes():
    #     G.add_node(node)
    #
    # # 遍历 G2 中的所有边，并将它们添加到 G 中
    # for edge in G2.edges():
